...
try:
    ...
    print "To build tank with support for message catalogs, you need "
...
if os.path.isdir('.git'):
    ...
    with open("tank/vcsversion.py", 'w') as version_file:
        version_file.write("""
...
setup(
    ...
    author='X7',
    author_email='x7@lists.launchpad.net',
    ...
    scripts=['bin/tank',
             'bin/tank-api',
             'bin/tank-cache-prefetcher',
             'bin/tank-cache-pruner',
             'bin/tank-cache-queue-image',
             'bin/tank-cache-manage',
             'bin/tank-cache-cleaner',
             'bin/tank-control',
             'bin/tank-manage',
             'bin/tank-registry',
             'bin/tank-scrubber'],
