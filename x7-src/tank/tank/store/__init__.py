...
from tank.store import location

logger = logging.getLogger('tank.store')
...
class ImageAddResult(object):
    ...
    def __init__(self, location, bytes_written, checksum=None):
        ...
        :param location: `tank.store.StoreLocation` object representing
