...
from tank.api import v1
from tank.api import versions
from tank.common import wsgi

logger = logging.getLogger('tank.api.middleware.version_negotiation')
...
class VersionNegotiationFilter(wsgi.Middleware):
    ...
    def process_request(self, req):
        ...
        if accept.startswith('application/vnd.x7.images-'):
            token_loc = len('application/vnd.x7.images-')
