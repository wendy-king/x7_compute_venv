...
import tank.registry.db.migration as migration_api
...
class TestMigrations(unittest.TestCase):
    ...
    TEST_DATABASES = {}
    # Test machines can set the TANK_TEST_MIGRATIONS_CONF variable
    # to override the location of the config file for migration testing
    CONFIG_FILE_PATH = os.environ.get('TANK_TEST_MIGRATIONS_CONF',
                                      os.path.join('tank', 'tests', 'unit',
                                                   'test_migrations.conf'))
    REPOSITORY_PATH = os.path.join('tank', 'registry', 'db', 'migrate_repo')
