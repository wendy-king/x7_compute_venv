...
from tank.registry import context as rcontext
from tank.registry.api import v1 as rserver
from tank.registry.db import api as db_api
from tank.registry.db import models as db_models
from tank.tests import stubs
    ...
    def setUp(self):
        ...
        self.FIXTURES = [
            {'id': UUID1,
             ...
             'min_ram': 0,
             'size': 13,
             'location': "chase://user:passwd@acct/container/obj.tar.0",
...
class TestTankAPI(unittest.TestCase):
    def setUp(self):
        """Establish a clean test environment"""
    ...
    def test_disable_purge_props(self):
        """
        Test the special x-tank-registry-purge-props header controls
        ...
        # passing the x-tank-registry-purge-props header and
