...
def get_socket(conf, default_port):
    ...
    note: Mostly comes from Chase with a few small changes...
...
class FilterFactory(AppFactory):
    ...
    This requires tank.filter_factory to be set to a callable which returns a
