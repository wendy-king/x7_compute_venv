...
class TankCacheConfigOpts(TankConfigOpts):

    def __init__(self, **kwargs):
        config_files = cfg.find_config_files(project='tank',
                                             prog='tank-cache')
        super(TankCacheConfigOpts, self).__init__(config_files, **kwargs)
