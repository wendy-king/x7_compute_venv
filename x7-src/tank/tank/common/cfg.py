...
Options can be strings, integers, floats, booleans, lists or 'multi strings':
    ...
    DEFAULT_EXTENSIONS = [
        'engine.api.x7.contrib.standard_extensions'
    ]
    osapi_extension_opt = \
...
If none are specified, a default set is used e.g. tank-api.conf and
tank-common.conf:
...
Option values may reference other values using PEP 292 string substitution:
    ...
    opts = [
        cfg.StrOpt('state_path',
                   ...
                   help='Top-level directory for maintaining engine state'),
