...
"""
This auth module is intended to allow X7 client-tools to select from a
...
class KeystoneStrategy(BaseStrategy):
    ...
    def authenticate(self):
        ...
        for _ in range(self.MAX_REDIRECTS):
            try:
                ...
                # 3. In some configurations engine makes redirection to
    ...
    def _do_request(url, method, headers=None, body=None):
        ...
        headers['User-Agent'] = 'tank-client'
