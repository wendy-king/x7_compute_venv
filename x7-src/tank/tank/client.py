...
"""
Client classes for callers of a Tank system
"""
...
import tank.api.v1
from tank.common import client as base_client
...
class V1Client(base_client.BaseClient):
    ...
    """Main client class for accessing Tank resources"""
        ...
        if hasattr(image_data, 'seek') and hasattr(image_data, 'tell'):
            try:
                ...
                if e.errno == errno.ESPIPE:
                    ...
                    # echo testdata | bin/tank add blah..., or
                    # that stdin is empty
                    return None
                else:
                    raise
    ...
    def delete_image(self, image_id):
        """
        Deletes Tank's information about an image
        """
