...
class Fedora(Distro):
    ...
    def post_process(self):
        ...
        Engine: https://bugs.launchpad.net/engine/+bug/884915
...
def print_help():
    ...
    Engine development uses virtualenv to track and manage Python dependencies
    while in development and testing.

    To activate the Engine virtualenv for the extent of your current shell
    session you can run:
