...
from engine.compute import manager as compute_manager
...
from engine.image import fake as fake_image
from engine import log as logging
from engine.network.quantum import client as quantum_client
from engine.notifier import test_notifier
from engine.scheduler import driver as scheduler_driver
from engine import rpc
from engine import test
from engine.tests import fake_network
...
flags.DECLARE('live_migration_retry_count', 'engine.compute.manager')
...
class ComputeTestCase(BaseTestCase):
    ...
    def test_wrap_instance_fault(self):
        ...
        @engine.compute.manager.wrap_instance_fault
    ...
    def test_run_instance_setup_block_device_mapping_fail(self):
        ...
        self.stubs.Set(engine.compute.manager.ComputeManager,
    ...
    def test_rescue(self):
        ...
        self.stubs.Set(engine.virt.fake.FakeConnection, 'rescue', fake_rescue)

        def fake_unrescue(self, instance_ref, network_info):
            called['unrescued'] = True

        self.stubs.Set(engine.virt.fake.FakeConnection, 'unrescue',
                       fake_unrescue)
    ...
    def test_power_on(self):
        ...
        self.stubs.Set(engine.virt.driver.ComputeDriver, 'power_on',
    ...
    def test_power_off(self):
        ...
        self.stubs.Set(engine.virt.driver.ComputeDriver, 'power_off',
    ...
    def test_set_admin_password_driver_error(self):
        ...
        self.stubs.Set(engine.virt.fake.FakeConnection, 'set_admin_password',
    ...
    def test_inject_file(self):
        ...
        self.stubs.Set(engine.virt.fake.FakeConnection, 'inject_file',
    ...
    def test_inject_network_info(self):
        ...
        self.stubs.Set(engine.virt.fake.FakeConnection, 'inject_network_info',
    ...
    def test_reset_network(self):
        ...
        self.stubs.Set(engine.virt.fake.FakeConnection, 'reset_network',
    ...
    def test_agent_update(self):
        ...
        self.stubs.Set(engine.virt.fake.FakeConnection, 'agent_update',
    ...
    def test_add_fixed_ip_usage_notification(self):
        ...
        self.stubs.Set(engine.network.API, 'add_fixed_ip_to_instance',
                       dummy)
        self.stubs.Set(engine.compute.manager.ComputeManager,
    ...
    def test_remove_fixed_ip_usage_notification(self):
        ...
        self.stubs.Set(engine.network.API, 'remove_fixed_ip_from_instance',
                       dummy)
        self.stubs.Set(engine.compute.manager.ComputeManager,
                       'inject_network_info', dummy)
        self.stubs.Set(engine.compute.manager.ComputeManager,
    ...
    def test_add_instance_fault(self):
        ...
        self.stubs.Set(engine.db, 'instance_fault_create', fake_db_fault_create)
...
class ComputeAPITestCase(BaseTestCase):
    ...
    def test_associate_floating_ip(self):
        ...
        self.stubs.Set(engine.network.API, 'associate_floating_ip',
                       fake_associate_ip_network_api)

        self.stubs.Set(engine.network.API, 'get_instance_nw_info',
                       fake_get_nw_info)
    ...
    def test_attach_volume(self):
        ...
        self.stubs.Set(engine.volume.api.API, 'check_attach', fake_check_attach)
    ...
    def test_get_actions(self):
        ...
        self.stubs.Set(engine.db, 'instance_get_actions',
                       fake_get_actions)
