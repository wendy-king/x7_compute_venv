...
class QuantumEngineTestCase(test.TestCase):
    def setUp(self):
...
class QuantumEngineIPAMTestCase(QuantumEngineTestCase):
...
class QuantumEngineMACGenerationTestCase(QuantumEngineTestCase):
