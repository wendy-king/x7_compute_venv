...
class MonkeyPatchTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.example_package = 'engine.tests.monkey_patch_example.'
        self.flags(
            monkey_patch=True,
    ...
    def test_monkey_patch(self):
        utils.monkey_patch()
        engine.tests.monkey_patch_example.CALLED_FUNCTION = []
        from engine.tests.monkey_patch_example import example_a, example_b
        ...
        self.assertTrue(package_a + 'example_function_a'
            in engine.tests.monkey_patch_example.CALLED_FUNCTION)
