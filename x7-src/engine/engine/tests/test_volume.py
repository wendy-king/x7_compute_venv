...
FLAGS = flags.FLAGS
LOG = logging.getLogger('engine.tests.volume')
...
class DriverTestCase(test.TestCase):
    ...
    driver_name = "engine.volume.driver.FakeBaseDriver"
...
class VolumeDriverTestCase(DriverTestCase):
    ...
    driver_name = "engine.volume.driver.VolumeDriver"
...
class ISCSITestCase(DriverTestCase):
    ...
    driver_name = "engine.volume.driver.ISCSIDriver"
