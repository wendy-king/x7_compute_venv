...
class RootLoggerTestCase(test.TestCase):
    ...
    def test_is_engine_instance(self):
        self.assert_(isinstance(self.log, log.EngineLogger))

    def test_name_is_engine(self):
        self.assertEqual("engine", self.log.name)

    def test_handlers_have_engine_formatter(self):
        formatters = []
        for h in self.log.handlers:
            f = h.formatter
            if isinstance(f, log.EngineFormatter):
                formatters.append(f)
...
class EngineFormatterTestCase(test.TestCase):
    def setUp(self):
        super(EngineFormatterTestCase, self).setUp()
    ...
    def tearDown(self):
        ...
        super(EngineFormatterTestCase, self).tearDown()
...
class EngineLoggerTestCase(test.TestCase):
    def setUp(self):
    ...
    def test_child_log_has_level_of_parent_flag(self):
        l = log.getLogger('engine-test.foo')
