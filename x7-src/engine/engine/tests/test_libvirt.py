...
from engine.virt.libvirt import connection
from engine.virt.libvirt import firewall
from engine.virt.libvirt import volume
from engine.volume import driver as volume_driver
from engine.virt.libvirt import utils as libvirt_utils
from engine.tests import fake_network
from engine.tests import fake_libvirt_utils
...
FLAGS = flags.FLAGS
LOG = logging.getLogger('engine.tests.test_libvirt')
...
class CacheConcurrencyTestCase(test.TestCase):
    def setUp(self):
        ...
        self.flags(instances_path='engine.compute.manager')
...
class LibvirtConnTestCase(test.TestCase):
    ...
    def create_fake_libvirt_mock(self, **kwargs):
        ...
        # Creating mocks
        volume_driver = 'iscsi=engine.tests.test_libvirt.FakeVolumeDriver'
        ...
        self.flags(libvirt_vif_driver="engine.tests.fake_network.FakeVIFDriver")
    ...
    def test_snapshot_in_ami_format(self):
        ...
        # Assign different image_ref from engine/images/fakes for testing ami
    ...
    def test_snapshot_no_image_architecture(self):
        ...
        # Assign different image_ref from engine/images/fakes for
...
class NWFilterTestCase(test.TestCase):
    ...
    def test_creates_base_rule_first(self):
        ...
        def _ensure_all_called(mac):
            instance_filter = 'engine-instance-%s-%s' % (instance_ref['name'],
                                                   mac.translate(None, ':'))
            secgroup_filter = 'engine-secgroup-%s' % self.security_group['id']
