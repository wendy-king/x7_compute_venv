...
class VolumesTest(integrated_helpers._IntegratedTestBase):
    ...
    def _poll_while(self, volume_id, continue_states, max_retries=5):
        ...
        while True:
            ...
            except client.X7ApiNotFoundException:
                found_volume = None
    ...
    def test_create_and_delete_volume(self):
        ...
        self.assertEquals(create_action['availability_zone'], 'engine')
        ...
        self.assertEquals(export_action['availability_zone'], 'engine')
    ...
    def test_attach_and_detach_volume(self):
        ...
        self.assertRaises(client.X7ApiNotFoundException,
