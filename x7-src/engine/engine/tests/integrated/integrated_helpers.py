...
import engine.image.tank
from engine.log import logging
from engine import service
from engine import test  # For the flags
...
class _IntegratedTestBase(test.TestCase):
    def setUp(self):
        ...
        def fake_get_image_service(context, image_href):
            ...
            return (engine.image.fake.FakeImageService(), image_id)
        self.stubs.Set(engine.image, 'get_image_service', fake_get_image_service)
        ...
        self.api = client.TestX7Client('fake', 'fake', self.auth_url)
    ...
    def _get_flags(self):
        ...
        f['image_service'] = 'engine.image.fake.FakeImageService'
        f['fake_network'] = True
        return f
