...
from engine.api.x7.v2.contrib import volumetypes
...
class VolumeTypesExtraSpecsTest(test.TestCase):
    ...
    def test_index(self):
        self.stubs.Set(engine.db, 'volume_type_extra_specs_get',
    ...
    def test_delete(self):
        self.stubs.Set(engine.db, 'volume_type_extra_specs_delete',
