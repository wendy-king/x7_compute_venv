...
from engine.api.x7.v2.contrib import server_action_list
...
class ServerActionsTest(test.TestCase):
    ...
    def setUp(self):
        ...
        self.stubs.Set(engine.compute.API, 'get_actions', fake_get_actions)
        self.stubs.Set(engine.compute.API, 'get', fake_instance_get)
        self.compute_api = engine.compute.API()
