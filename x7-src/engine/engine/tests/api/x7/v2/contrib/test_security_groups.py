...
from engine.api.x7.v2.contrib import security_groups
...
class TestSecurityGroups(test.TestCase):
    ...
    def test_get_security_group_list(self):
        ...
        self.stubs.Set(engine.db, 'security_group_get_by_project',
    ...
    def test_get_security_group_by_id(self):
        ...
        self.stubs.Set(engine.db, 'security_group_get',
    ...
    def test_delete_security_group_by_id(self):
        ...
        self.stubs.Set(engine.db, 'security_group_destroy',
    ...
    def test_associate_non_existing_instance(self):
        self.stubs.Set(engine.db, 'instance_get', return_server_nonexistent)
    ...
    def test_associate_non_running_instance(self):
        self.stubs.Set(engine.db, 'instance_get', return_non_running_server)
        self.stubs.Set(engine.db, 'instance_get_by_uuid',
                       return_non_running_server)
        self.stubs.Set(engine.db, 'security_group_get_by_name',
    ...
    def test_associate(self):
        ...
        self.stubs.Set(engine.db, 'instance_get_by_uuid',
                       return_server_by_uuid)
        self.mox.StubOutWithMock(engine.db, 'instance_add_security_group')
        engine.db.instance_add_security_group(mox.IgnoreArg(),
                                            mox.IgnoreArg(),
                                            mox.IgnoreArg())
        self.stubs.Set(engine.db, 'security_group_get_by_name',
                       return_security_group_without_instances)
    ...
    def test_disassociate(self):
        ...
        self.stubs.Set(engine.db, 'instance_get_by_uuid',
                       return_server_by_uuid)
        self.mox.StubOutWithMock(engine.db, 'instance_remove_security_group')
        engine.db.instance_remove_security_group(mox.IgnoreArg(),
                                    mox.IgnoreArg(),
                                    mox.IgnoreArg())
        self.stubs.Set(engine.db, 'security_group_get_by_name',
                       return_security_group_by_name)
...
class TestSecurityGroupRules(test.TestCase):
    ...
    def test_delete(self):
        ...
        self.stubs.Set(engine.db, 'security_group_rule_get',
                       security_group_rule_get)
        self.stubs.Set(engine.db, 'security_group_rule_destroy',
