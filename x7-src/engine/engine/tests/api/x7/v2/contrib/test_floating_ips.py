...
from engine.api.x7.v2.contrib import floating_ips
...
class FloatingIpTest(test.TestCase):
    ...
    def test_translate_floating_ip_view_dict(self):
        floating_ip = {'id': 0, 'address': '10.0.0.10', 'pool': 'engine',
                       'fixed_ip': None}
        view = floating_ips._translate_floating_ip_view(floating_ip)
        self.assertTrue('floating_ip' in view)
...
# test floating ip allocate/release(deallocate)
    ...
    def test_floating_ip_allocate(self):
        ...
        def fake2(*args, **kwargs):
            return {'id': 1, 'address': '10.10.10.10', 'pool': 'engine'}
