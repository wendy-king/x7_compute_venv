...
class ServerMetaDataTest(test.TestCase):
    ...
    def test_delete(self):
        self.stubs.Set(engine.db, 'instance_metadata_get',
                       return_server_metadata)
        self.stubs.Set(engine.db, 'instance_metadata_delete',
    ...
    def test_delete_nonexistant_server(self):
        self.stubs.Set(engine.db, 'instance_get', return_server_nonexistant)
    ...
    def test_create(self):
        self.stubs.Set(engine.db, 'instance_metadata_get',
                       return_server_metadata)
        self.stubs.Set(engine.db, 'instance_metadata_update',
