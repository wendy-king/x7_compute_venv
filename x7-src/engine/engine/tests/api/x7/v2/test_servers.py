...
import engine.compute.api
from engine.compute import instance_types
from engine.compute import task_states
from engine.compute import vm_states
import engine.db
from engine.db.sqlalchemy.models import InstanceActions
from engine.db.sqlalchemy.models import InstanceMetadata
from engine import flags
import engine.image.fake
import engine.rpc
import engine.scheduler.api
...
class ServersControllerTest(test.TestCase):
    def setUp(self):
        ...
        self.stubs.Set(engine.db, 'instance_get_all_by_project',
                       return_servers)
        self.stubs.Set(engine.db, 'instance_add_security_group',
                       return_security_group)
        self.stubs.Set(engine.db, 'instance_update', instance_update)
        self.stubs.Set(engine.db, 'instance_get_fixed_addresses',
                       instance_addresses)
        self.stubs.Set(engine.db, 'instance_get_floating_address',
                       instance_addresses)
    ...
    def test_get_server_with_active_status_by_id(self):
        ...
        self.stubs.Set(engine.db, 'instance_get', new_return_server)
    ...
    def test_get_server_by_id_malformed_networks(self):
        ...
        self.stubs.Set(engine.db, 'instance_get_by_uuid', fake_instance_get)
    ...
    def test_get_server_addresses(self):
        ...
        new_return_server = return_server_with_attributes_by_uuid(
                public_ips=publics, private_ips=privates)
        self.stubs.Set(engine.db, 'instance_get_by_uuid', new_return_server)
    ...
    def test_get_server_addresses_nonexistant_server(self):
        def fake_instance_get(*args, **kwargs):
            raise engine.exception.InstanceNotFound()
    ...
    def test_get_server_list_with_reservation_id(self):
        self.stubs.Set(engine.db, 'instance_get_all_by_reservation',
                       return_servers_by_reservation)
        self.stubs.Set(engine.scheduler.api, 'call_zone_method',
    ...
    def test_get_servers_with_bad_option(self):
        ...
        self.stubs.Set(engine.compute.API, 'get_all', fake_get_all)
    ...
    def test_update_server_adminPass_ignored(self):
        ...
        self.stubs.Set(engine.db, 'instance_update', server_update)
        self.stubs.Set(engine.db, 'instance_get',
                return_server_with_attributes(name='server_test'))
    ...
    def test_delete_server_instance(self):
        ...
        self.stubs.Set(engine.db, 'instance_destroy', instance_destroy_mock)
...
class ServerStatusTest(test.TestCase):
    ...
    def _get_with_state(self, vm_state, task_state=None):
        ...
        self.stubs.Set(engine.db, 'instance_get_by_uuid', new_server)
        self.stubs.Set(engine.db, 'instance_get', new_server)
...
class ServersControllerCreateTest(test.TestCase):
    ...
    def setUp(self):
        ...
        self.stubs.Set(engine.db, 'instance_add_security_group',
                       return_security_group)
        self.stubs.Set(engine.db, 'project_get_networks',
                       project_get_networks)
        self.stubs.Set(engine.db, 'instance_create', instance_create)
        self.stubs.Set(engine.db, 'instance_get', instance_get)
        self.stubs.Set(engine.rpc, 'cast', fake_method)
        self.stubs.Set(engine.rpc, 'call', rpc_call_wrapper)
        self.stubs.Set(engine.db, 'instance_update', server_update)
        self.stubs.Set(engine.db, 'queue_get_for', queue_get_for)
        self.stubs.Set(engine.network.manager.VlanManager, 'allocate_fixed_ip',
                       fake_method)
        self.stubs.Set(engine.compute.api.API, "_find_host", find_host)
...
class TestServerCreateRequestXMLDeserializer(test.TestCase):
    ...
    def test_minimal_request(self):
        serial_request = """
<server xmlns="http://docs.x7.org/compute/api/v2"
...
<server xmlns="http://docs.x7.org/compute/api/v2"
    ...
    def test_spec_request(self):
        image_bookmark_link = "http://servers.api.x7.org/1234/" + \
  ...
  <personality>
    <file path="/etc/banner.txt">Mg==</file>
        ...
        expected = {
            "server": {
                "name": "new-server-test",
                "imageRef": "http://servers.api.x7.org/1234/" + \
                            "images/52415800-8b69-11e0-9b19-734f6f006e54",
                "flavorRef": "52415800-8b69-11e0-9b19-734f1195ff37",
...
class TestAddressesXMLSerialization(test.TestCase):
    ...
    index_serializer = engine.api.x7.v2.ips.AddressesTemplate()
    show_serializer = engine.api.x7.v2.ips.NetworkTemplate()
...
class ServersViewBuilderTest(test.TestCase):
    ...
    def setUp(self):
        ...
        self.view_builder = engine.api.x7.v2.views.servers.ViewBuilder()
