...
class ServerActionsControllerTest(test.TestCase):
    ...
    def test_server_change_password(self):
        ...
        self.stubs.Set(engine.compute.api.API, 'set_admin_password', mock_method)
    ...
    def test_rebuild_rejected_when_building(self):
        ...
        self.stubs.Set(engine.compute.api.API, 'rebuild', fake_rebuild)
    ...
    def test_rebuild_server_not_found(self):
        ...
        self.stubs.Set(engine.db, 'instance_get', server_not_found)
    ...
    def test_rebuild_accessIP(self):
        ...
        self.stubs.Set(engine.compute.API, 'update', update)
        req = fakes.HTTPRequest.blank(self.url)
    ...
    def test_resize_server(self):
        ...
        self.stubs.Set(engine.compute.api.API, 'resize', resize_mock)
    ...
    def test_confirm_resize_server(self):
        ...
        self.stubs.Set(engine.compute.api.API, 'confirm_resize', cr_mock)
    ...
    def test_confirm_resize_migration_not_found(self):
        ...
        self.stubs.Set(engine.compute.api.API,
                       'confirm_resize',
                       confirm_resize_mock)
    ...
    def test_revert_resize_server(self):
        ...
        self.stubs.Set(engine.compute.api.API, 'revert_resize', revert_mock)
    ...
    def test_create_image_conflict_snapshot(self):
        ...
        self.stubs.Set(engine.compute.API, 'snapshot', snapshot)
...
class TestServerActionXMLDeserializer(test.TestCase):
    ...
    def test_create_image(self):
        serial_request = """
<createImage xmlns="http://docs.x7.org/compute/api/v1.1"
...
<createImage xmlns="http://docs.x7.org/compute/api/v1.1"
    ...
    def test_change_pass(self):
        serial_request = """<?xml version="1.0" encoding="UTF-8"?>
                <changePassword
                    xmlns="http://docs.x7.org/compute/api/v1.1"
                    adminPass="1234pass"/> """
        request = self.deserializer.deserialize(serial_request, 'action')
        expected = {
            "changePassword": {
