...
from engine.api.x7.v2.views import images as images_view
...
class ImagesControllerTest(test.TestCase):
    """
    Test of the X7 API /images application controller w/Tank.
    """
    ...
    def test_get_image(self):
        ...
        alternate = "%s/fake/images/124" % utils.generate_tank_url()
        ...
        expected_images = [
            {
                ...
                "links": [
                    ...
                    },
                    {
                        "rel": "alternate",
                        "type": "application/vnd.x7.image",
                        "href": alternate % (utils.generate_tank_url(), 123),
                    },
                ],
            },
            {
                ...
                "links": [
                    ...
                    },
                    {
                        "rel": "alternate",
                        "type": "application/vnd.x7.image",
                        "href": alternate % (utils.generate_tank_url(), 124),
                    },
                ],
            },
            {
                ...
                "links": [
                    ...
                    },
                    {
                        "rel": "alternate",
                        "type": "application/vnd.x7.image",
                        "href": alternate % (utils.generate_tank_url(), 125),
                    },
                ],
            },
        ]
    ...
    def test_get_image_details(self):
        ...
        },
        {
            ...
            },
            {
                "rel": "alternate",
                "type": "application/vnd.x7.image",
                "href": "%s/fake/images/125" % utils.generate_tank_url()
            }],
        },
        {
            'id': '126',
            ...
            },
            {
                "rel": "alternate",
                "type": "application/vnd.x7.image",
                "href": "%s/fake/images/126" % utils.generate_tank_url()
            }],
        },
        {
            'id': '127',
            ...
            },
            {
                "rel": "alternate",
                "type": "application/vnd.x7.image",
                "href": "%s/fake/images/127" % utils.generate_tank_url()
            }],
        },
        {
            'id': '128',
            ...
            },
            {
                "rel": "alternate",
                "type": "application/vnd.x7.image",
                "href": "%s/fake/images/128" % utils.generate_tank_url()
            }],
        },
        {
            'id': '129',
            ...
            },
            {
                "rel": "alternate",
                "type": "application/vnd.x7.image",
                "href": "%s/fake/images/129" % utils.generate_tank_url()
            }],
        },
        {
            'id': '130',
            ...
            },
            {
                "rel": "alternate",
                "type": "application/vnd.x7.image",
                "href": "%s/fake/images/130" % utils.generate_tank_url()
            }],
        },
        ]
    ...
    def test_generate_alternate_link(self):
        ...
        actual_url = "%s/fake/images/1" % utils.generate_tank_url()
