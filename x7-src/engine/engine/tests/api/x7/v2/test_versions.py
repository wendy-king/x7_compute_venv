...
from engine.tests.api.x7 import common
        ...
        "media-types": [
            {
                ...
                "type": "application/vnd.x7.compute+xml;version=2",
            },
            {
                "base": "application/json",
                "type": "application/vnd.x7.compute+json;version=2",
            },
        ],
    },
}
                ...
                "media-types": [
                    {
                        "base": "application/xml",
                        "type": "application/"
                                "vnd.x7.compute+xml;version=2",
                    },
                    {
                        "base": "application/json",
                        "type": "application/"
                                "vnd.x7.compute+json;version=2",
                    },
                ],
            },
        }
