...
"""
Test suites for 'common' code used throughout the X7 HTTP API.
"""
...
class LimiterTest(test.TestCase):
    """
    Unit tests for the `engine.api.x7.common.limited` method which takes
...
class PaginationParamsTest(test.TestCase):
    """
    Unit tests for the `engine.api.x7.common.get_pagination_params`
...
class MetadataXMLDeserializationTest(test.TestCase):
    ...
    def test_create(self):
        request_body = """
        <metadata xmlns="http://docs.x7.org/compute/api/v1.1">
    ...
    def test_update(self):
        request_body = """
        <meta xmlns="http://docs.x7.org/compute/api/v1.1"
              key='123'>asdf</meta>"""
