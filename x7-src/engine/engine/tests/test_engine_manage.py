...
TOPDIR = os.path.normpath(os.path.join(
                            ...
                            os.pardir,
                            os.pardir))
ENGINE_MANAGE_PATH = os.path.join(TOPDIR, 'bin', 'engine-manage')

sys.dont_write_bytecode = True
import imp
engine_manage = imp.load_source('engine_manage.py', ENGINE_MANAGE_PATH)
...
class FixedIpCommandsTestCase(test.TestCase):
    def setUp(self):
        ...
        self.commands = engine_manage.FixedIpCommands()
...
class NetworkCommandsTestCase(test.TestCase):
    def setUp(self):
        ...
        self.stubs = stubout.StubOutForTesting()
        self.commands = engine_manage.NetworkCommands()
    ...
    def test_create(self):
        ...
        self.flags(network_manager='engine.network.manager.VlanManager')
        from engine.network import manager as net_manager
