...
LOG = logging.getLogger('engine.tests.network')
...
class FlatNetworkTestCase(test.TestCase):
    def setUp(self):
        ...
        temp = utils.import_object('engine.network.minidns.MiniDNS')
...
class RPCAllocateTestCase(test.TestCase):
    """Tests engine.network.manager.RPCAllocateFixedIP"""
    def setUp(self):
...
class FloatingIPTestCase(test.TestCase):
    """Tests engine.network.manager.FloatingIP"""
    def setUp(self):
