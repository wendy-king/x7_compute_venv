...
def get_test_admin_context():
    return engine.context.get_admin_context()
...
def get_test_instance_type(context=None):
    ...
    instance_type_ref = engine.db.instance_type_create(context,
            test_instance_type)
...
def get_test_instance(context=None):
    ...
    instance_ref = engine.db.instance_create(context, test_instance)
    return instance_ref
