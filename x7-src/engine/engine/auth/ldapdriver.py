...
LOG = logging.getLogger("engine.ldapdriver")


if FLAGS.memcached_servers:
    import memcache
else:
    from engine.testing.fake import memcache
...
class LdapDriver(object):
    ...
    isadmin_attribute = 'isEngineAdmin'
    ...
    def __init__(self):
        ...
        if FLAGS.ldap_schema_version == 1:
            LdapDriver.project_pattern = '(objectclass=engineProject)'
            LdapDriver.isadmin_attribute = 'isAdmin'
            LdapDriver.project_attribute = 'projectManager'
            LdapDriver.project_objectclass = 'engineProject'
        self.__cache = None
    ...
    def __get_ldap_user(self, uid):
        ...
        dn = FLAGS.ldap_user_subtree
        query = ('(&(%s=%s)(objectclass=engineUser))' %
...
class FakeLdapDriver(LdapDriver):
    ...
    def __init__(self):
        import engine.auth.fakeldap
        sys.modules['ldap'] = engine.auth.fakeldap
