...
LOG = logging.getLogger('engine.compute.api')


FLAGS = flags.FLAGS
flags.DECLARE('enable_zone_routing', 'engine.scheduler.api')
flags.DECLARE('vncproxy_topic', 'engine.vnc')
...
class API(base.Base):
    ...
    def __init__(self, image_service=None, network_api=None, volume_api=None,
        ...
        self.image_service = image_service or \
                engine.image.get_default_image_service()
    ...
    def _create_instance(self, context, instance_type,
        ...
        (image_service, image_id) = engine.image.get_image_service(context,
                                                                 image_href)
    ...
    def routing_get(self, context, instance_id):
        ...
        intend to to. It will route to engineclient.get if the instance is not
        found.
        """
    ...
    def get_all(self, context, search_opts=None):
        ...
        children = scheduler_api.call_zone_method(context,
                "list",
                errors_to_ignore=[engineclient.exceptions.NotFound],
                engineclient_collection_name="servers",
    ...
    def backup(self, context, instance, name, backup_type, rotation,
        ...
        :param instance: engine.db.sqlalchemy.models.Instance
