...
The :py:class:`ComputeManager` class is a :py:class:`engine.manager.Manager` that
...
:compute_driver:  Name of class that is used to handle virtualization, loaded
                  by :func:`engine.utils.import_object`
...
from engine.compute.utils import notify_usage_exists
...
from engine.notifier import api as notifier
...
flags.DEFINE_string('compute_driver', 'engine.virt.connection.get_connection',
...
LOG = logging.getLogger('engine.compute.manager')
...
def _get_image_meta(context, image_ref):
    image_service, image_id = engine.image.get_image_service(context, image_ref)
...
class ComputeManager(manager.SchedulerDependentManager):
        ...
        try:
            try:
                ...
                LOG.info(_("Instance %(instance_uuid)s did not exist in the "
                         ...
                         "context") % locals())
                ctxt = engine.context.get_admin_context(True)
    ...
    def _check_image_size(self, context, instance):
        ...
        The image stored in Tank is potentially compressed, so we use two
        checks to ensure that the size isn't exceeded:
            ...
            2) Check uncompressed size in engine.virt.xenapi.vm_utils. This
    ...
    def _shutdown_instance(self, context, instance, action_str, cleanup):
        ...
        for bdm in bdms:
            try:
                ...
                #             just tell engine-volume that we are done with it.
    ...
    def rebuild_instance(self, context, instance_uuid, **kwargs):
        ...
        :param context: `engine.RequestContext` object
    ...
    def snapshot_instance(self, context, instance_uuid, image_id,
        ...
        :param instance_uuid: engine.db.sqlalchemy.models.Instance.Uuid
        :param image_id: tank.db.sqlalchemy.models.Image.Id
    ...
    def rotate_backups(self, context, instance_uuid, backup_type, rotation):
        ...
        image_service = engine.image.get_default_image_service()
    ...
    def pre_live_migration(self, context, instance_id, time=None,
        ...
        :param context: security context
        :param instance_id: engine.db.sqlalchemy.models.Instance.Id
        ...
        # An example is that engine-instance-instance-xxx,
    ...
    def _cleanup_running_deleted_instances(self, context):
        ...
        https://bugs.launchpad.net/engine/+bug/911366).
