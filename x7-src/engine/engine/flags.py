...
DEFINE_string('tank_host', _get_my_ip(), 'default tank host')
DEFINE_integer('tank_port', 9292, 'default tank port')
DEFINE_list('tank_api_servers',
            ['%s:%d' % (FLAGS.tank_host, FLAGS.tank_port)],
            'list of tank api servers available to engine (host:port)')
DEFINE_integer('tank_num_retries', 0,
               'The number of times to retry downloading an image from tank')
...
DEFINE_string('vsa_topic', 'vsa', 'the topic that engine-vsa service listens on')
...
DEFINE_string('control_exchange', 'engine', 'the main exchange to connect to')
...
DEFINE_multistring('osapi_extension',
                   ['engine.api.x7.v2.contrib.standard_extensions'],
                   'osapi extension to load')
DEFINE_string('osapi_host', '$my_ip', 'ip of api server')
DEFINE_string('osapi_scheme', 'http', 'prefix for x7')
DEFINE_integer('osapi_port', 8774, 'X7 API port')
DEFINE_string('osapi_path', '/v1.1/', 'suffix for x7')
...
DEFINE_string('default_project', 'x7', 'default project for x7')
...
DEFINE_string('state_path', os.path.join(os.path.dirname(__file__), '../'),
              "Top-level directory for maintaining engine's state")
...
DEFINE_string('sqlite_db', 'engine.sqlite', 'file name for sqlite')
...
DEFINE_string('compute_manager', 'engine.compute.manager.ComputeManager',
              'Manager for compute')
DEFINE_string('console_manager', 'engine.console.manager.ConsoleProxyManager',
              'Manager for console proxy')
DEFINE_string('instance_dns_manager',
              'engine.network.dns_driver.DNSDriver',
...
DEFINE_multistring('floating_ip_dns_zones', '',
                   ...
                   'e.g. "example.org"')
DEFINE_string('network_manager', 'engine.network.manager.VlanManager',
              'Manager for network')
DEFINE_string('volume_manager', 'engine.volume.manager.VolumeManager',
              'Manager for volume')
DEFINE_string('scheduler_manager', 'engine.scheduler.manager.SchedulerManager',
              'Manager for scheduler')
DEFINE_string('vsa_manager', 'engine.vsa.manager.VsaManager',
              'Manager for vsa')
DEFINE_string('vc_image_name', 'vc_image',
              'the VC image ID (for a VC image that exists in DB Tank)')
...
DEFINE_string('image_service', 'engine.image.tank.TankImageService',
...
DEFINE_string('node_availability_zone', 'engine',
...
DEFINE_string('zone_name', 'engine', 'name of this zone')
...
DEFINE_string('network_driver', 'engine.network.linux_net',
...
DEFINE_list('monkey_patch_modules',
        ['engine.api.ec2.cloud:engine.notifier.api.notify_decorator',
        'engine.compute.api:engine.notifier.api.notify_decorator'],
