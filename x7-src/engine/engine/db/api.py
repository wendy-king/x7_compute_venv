...
Functions in this module are imported into the engine.db namespace. Call these
functions from engine.db namespace, not the engine.db.api namespace.
...
:sql_connection:  string specifying the sqlalchemy connection to use, like:
                  `sqlite:///var/lib/engine/engine.sqlite`.
...
IMPL = utils.LazyPluggable(FLAGS['db_backend'],
                           sqlalchemy='engine.db.sqlalchemy.api')
