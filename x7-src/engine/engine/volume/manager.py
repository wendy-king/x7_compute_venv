...
:volume_manager:  The module name of a class derived from
                  ...
                  :class:`engine.volume.manager.Manager`).
:storage_availability_zone:  Defaults to `engine`.
:volume_driver:  Used by :class:`Manager`.  Defaults to
                 :class:`engine.volume.driver.ISCSIDriver`.
...
LOG = logging.getLogger('engine.volume.manager')
FLAGS = flags.FLAGS
flags.DEFINE_string('storage_availability_zone',
                    'engine',
                    'availability zone of this service')
flags.DEFINE_string('volume_driver', 'engine.volume.driver.ISCSIDriver',
