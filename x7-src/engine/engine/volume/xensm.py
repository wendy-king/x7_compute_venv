...
from engine.volume.driver import VolumeDriver
from engine.virt.xenapi_conn import XenAPISession
from engine.virt.xenapi.volumeops import VolumeOps

LOG = logging.getLogger("engine.volume.xensm")
FLAGS = flags.FLAGS
...
class XenSMDriver(VolumeDriver):
    ...
    def create_volume(self, volume):
        ...
        for backend in backends:
            ...
            # This needs to be done because if engine compute and
