...
class IP(Model):
    """Represents an IP address in Engine"""
...
class FixedIP(IP):
    """Represents a Fixed IP address in Engine"""
...
class Route(Model):
    """Represents an IP Route in Engine"""
...
class Network(Model):
    """Represents a Network in Engine"""
...
class VIF(Model):
    """Represents a Virtual Interface in Engine"""
...
class NetworkInfo(list):
    """Stores and manipulates network information for a Engine instance"""
