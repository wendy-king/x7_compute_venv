...
from engine.network.quantum import melange_connection as melange
from engine import utils


LOG = logging.getLogger("engine.network.quantum.engine_ipam_lib")

FLAGS = flags.FLAGS


def get_ipam_lib(net_man):
    return QuantumEngineIPAMLib(net_man)


class QuantumEngineIPAMLib(object):
    """Implements Quantum IP Address Management (IPAM) interface
       using the local Engine database.  This implementation is inline
