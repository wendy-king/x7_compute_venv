...
For assistance and guidelines pls contact
    Zadara Storage Inc & X7 community
"""
...
flags.DEFINE_string('vsa_ec2_access_key', None,
                    'EC2 access key used by VSA for accessing engine')
flags.DEFINE_string('vsa_ec2_user_id', None,
                    'User ID used by VSA for accessing engine')
...
LOG = logging.getLogger('engine.vsa')
