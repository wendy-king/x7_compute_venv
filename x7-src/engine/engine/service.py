...
flags.DEFINE_string('osapi_listen', "0.0.0.0",
                    'IP address for X7 API to listen')
flags.DEFINE_integer('osapi_listen_port', 8774, 'port for os api to listen')
flags.DEFINE_string('metadata_manager', 'engine.api.manager.MetadataManager',
                    'X7 metadata service manager')
...
flags.DEFINE_string('api_paste_config', "api-paste.ini",
                    'File name for the paste.deploy config for engine-api')
...
class Service(object):
    ...
    def create(cls, host=None, binary=None, topic=None, manager=None,
        ...
        :param topic: defaults to bin_name - 'engine-' part
        ...
        if not topic:
            topic = binary.rpartition('engine-')[2]
        if not manager:
