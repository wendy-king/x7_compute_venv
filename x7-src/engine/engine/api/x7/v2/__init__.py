...
"""
WSGI middleware for X7 API controllers.
"""
...
from engine.api.x7.v2 import consoles
...
class APIRouter(base_wsgi.Router):
    """
    Routes requests on the X7 API to the appropriate controller
    and method.
    """

    @classmethod
    def factory(cls, global_config, **local_config):
        """Simple paste factory, :class:`engine.wsgi.Router` doesn't have one"""
        return cls()
