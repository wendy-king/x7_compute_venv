...
class ExtensionMiddleware(base_wsgi.Middleware):
    ...
    def __init__(self, application, ext_mgr=None):
        ...
        mapper = engine.api.x7.v2.ProjectMapper()
...
class ExtensionManager(object):
    ...
    See engine/tests/api/x7/extensions/foxinsocks/extension.py for an
...
class RequestExtension(object):
    """Extend requests and responses of core engine X7 API resources.

    Provide a way to add data to responses and handle custom request data
    that is sent to core engine X7 API controllers.
...
class ActionExtension(object):
    """Add custom actions to core engine X7 API resources."""
...
class ResourceExtension(object):
    """Add top level resources to the X7 API in engine."""
