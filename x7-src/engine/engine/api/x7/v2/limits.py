...
from engine.api.x7.v2.views import limits as limits_views
...
class LimitsController(object):
    """
    Controller for accessing limits in the X7 API.
    """
...
class RateLimitingMiddleware(base_wsgi.Middleware):
    ...
    def __call__(self, req):
        ...
        verb = req.method
        url = req.url
        context = req.environ.get("engine.context")
        ...
        req.environ["engine.limits"] = self._limiter.get_limits(username)
