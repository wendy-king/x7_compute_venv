...
LOG = logging.getLogger("engine.api.x7.v2.contrib.volumes")
...
class VolumeController(object):
    """The Volumes API controller for the X7 API."""
...
class VolumeAttachmentController(object):
    """The volume attachment API controller for the X7 API.
...
class BootFromVolumeController(servers.Controller):
    """The boot from volume API controller for the X7 API."""
...
class Volumes(extensions.ExtensionDescriptor):
    ...
    name = "Volumes"
    alias = "os-volumes"
    namespace = "http://docs.x7.org/compute/ext/volumes/api/v1.1"
