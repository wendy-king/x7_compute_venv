...
from engine.api.x7.v2 import extensions as exts
...
FLAGS = flags.FLAGS
LOG = logging.getLogger("engine.api.x7.v2.contrib.rescue")
...
class Rescue(exts.ExtensionDescriptor):
    ...
    name = "Rescue"
    alias = "os-rescue"
    namespace = "http://docs.x7.org/compute/ext/rescue/api/v1.1"
