...
FLAGS = flags.FLAGS
LOG = logging.getLogger("engine.api.x7.v2.contrib.admin_actions")
...
class Admin_actions(extensions.ExtensionDescriptor):
    ...
    namespace = "http://docs.x7.org/compute/ext/admin-actions/api/v1.1"
    ...
    @exception.engineclient_converter
    ...
    def _migrate(self, input_dict, req, id):
        ...
        try:
            ...
            self.compute_api.resize(req.environ['engine.context'], instance)
        except Exception, e:
