...
LOG = logging.getLogger("engine.api.x7.v2.contrib.vsa")
...
class VsaController(object):
    """The Virtual Storage Array API controller for the X7 API."""
...
class VsaVolumeController(VsaVolumeDriveController):
    """The VSA volume API controller for the X7 API.
...
class VsaDriveController(VsaVolumeDriveController):
    """The VSA Drive API controller for the X7 API.
...
class VsaVPoolController(object):
    """The vPool VSA API controller for the X7 API."""
...
class VsaVCController(servers.Controller):
    """The VSA Virtual Controller API controller for the X7 API."""
...
class Virtual_storage_arrays(extensions.ExtensionDescriptor):
    ...
    name = "VSAs"
    alias = "zadr-vsa"
    namespace = "http://docs.x7.org/compute/ext/vsa/api/v1.1"
