...
FLAGS = flags.FLAGS
LOG = logging.getLogger('engine.api.x7.v2.contrib.accounts')
...
class Controller(object):
    ...
    def delete(self, req, id):
        self._check_admin(req.environ['engine.context'])
...
class Accounts(extensions.ExtensionDescriptor):
    ...
    name = "Accounts"
    alias = "os-accounts"
    namespace = "http://docs.x7.org/compute/ext/accounts/api/v1.1"
