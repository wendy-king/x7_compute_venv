...
LOG = logging.getLogger('engine.api.x7.v2.contrib.floating_ip_poolss')
...
class FloatingIPPoolsController(object):
    """The Floating IP Pool API controller for the X7 API."""
...
class Floating_ip_pools(extensions.ExtensionDescriptor):
    ...
    namespace = \
        "http://docs.x7.org/compute/ext/floating_ip_pools/api/v1.1"
