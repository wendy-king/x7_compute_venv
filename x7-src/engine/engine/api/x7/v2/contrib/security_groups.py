...
LOG = logging.getLogger("engine.api.x7.v2.contrib.security_groups")
FLAGS = flags.FLAGS
...
class SecurityGroupController(object):
    """The Security group API controller for the X7 API."""
...
class Security_groups(extensions.ExtensionDescriptor):
    ...
    namespace = "http://docs.x7.org/compute/ext/securitygroups/api/v1.1"
