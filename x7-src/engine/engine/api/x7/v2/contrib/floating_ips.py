...
LOG = logging.getLogger('engine.api.x7.v2.contrib.floating_ips')
...
class FloatingIPController(object):
    """The Floating IPs API controller for the X7 API."""
...
class Floating_ips(extensions.ExtensionDescriptor):
    ...
    namespace = "http://docs.x7.org/compute/ext/floating_ips/api/v1.1"
