...
class KeypairController(object):
    """ Keypair API controller for the X7 API """

    # TODO(ja): both this file and engine.api.ec2.cloud.py have similar logic.
    # move the common keypair logic to engine.compute.API?
...
class Keypairs(extensions.ExtensionDescriptor):
    ...
    name = "Keypairs"
    alias = "os-keypairs"
    namespace = "http://docs.x7.org/compute/ext/keypairs/api/v1.1"
