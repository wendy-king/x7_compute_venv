...
class VolumeTypesController(object):
    """ The volume types API controller for the X7 API """
...
class VolumeTypeExtraSpecsController(object):
    """ The volume type extra specs API controller for the X7 API """
...
class Volumetypes(extensions.ExtensionDescriptor):
    ...
    namespace = "http://docs.x7.org/compute/ext/volume_types/api/v1.1"
