...
LOG = logging.getLogger('engine.api.x7.common')
FLAGS = flags.FLAGS


XML_NS_V11 = 'http://docs.x7.org/compute/api/v1.1'
...
def remove_version_from_href(href):
    ...
    Given: 'http://www.engine.com/v1.1/123'
    Returns: 'http://www.engine.com/123'

    Given: 'http://www.engine.com/v1.1'
    Returns: 'http://www.engine.com'
