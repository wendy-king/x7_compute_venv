...
from engine.api.ec2 import apirequest
from engine.api.ec2 import ec2utils
from engine.api.ec2 import faults
...
class NoAuth(wsgi.Middleware):
    """Add user:project as 'engine.context' to WSGI environ."""
...
class Authenticate(wsgi.Middleware):
    """Authenticate an EC2 request and add 'engine.context' to WSGI environ."""
...
class Executor(wsgi.Application):
    ...
    Executes 'ec2.request', passing 'engine.context' (both variables in WSGI
