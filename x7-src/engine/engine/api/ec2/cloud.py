...
flags.DECLARE('service_down_time', 'engine.scheduler.driver')

LOG = logging.getLogger("engine.api.ec2.cloud")
...
"""
    ...
    def setup(self):
        ...
        # FIXME(ja): this should be moved to a engine-manage command,
    ...
    def _describe_availability_zones_verbose(self, context, **kwargs):
        rv = {'availabilityZoneInfo': [{'zoneName': 'engine',
                                        'zoneState': 'available'}]}
    ...
    def _format_image(self, image):
        """Convert from format defined by TankImageService to S3 format."""
        i = {}
