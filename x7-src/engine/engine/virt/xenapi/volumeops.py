...
from engine.virt.xenapi.volume_utils import VolumeHelper
from engine.virt.xenapi.volume_utils import StorageError


LOG = logging.getLogger("engine.virt.xenapi.volumeops")
