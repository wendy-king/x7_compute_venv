...
from engine.compute import api as compute
...
from engine.virt.xenapi import network_utils
...
XenAPI = None
LOG = logging.getLogger("engine.virt.xenapi.vmops")
...
flags.DEFINE_string('xenapi_vif_driver',
                    'engine.virt.xenapi.vif.XenAPIBridgeDriver',
...
class VMOps(object):
    ...
    def list_instances_detail(self):
        ...
        for vm_ref, vm_rec in VMHelper.list_vms(self._session):
            ...
            x7_format = VMHelper.compile_info(vm_rec)
            state = x7_format['state']
    ...
    def _create_vm(self, context, instance, vdis, network_info, image_meta):
        ...
        try:
            ...
            if instance.vm_mode != vm_mode:
                ...
                db.instance_update(engine_context.get_admin_context(),
    ...
    def _attach_disks(self, instance, disk_image_type, vm_ref, first_vdi_ref,
            vdis):
        ctx = engine_context.get_admin_context()
    ...
    def snapshot(self, context, instance, image_id):
        ...
        3. Push-to-tank: Once coalesced, we call a plugin on the XenServer
        ...
        try:
            ...
            # call plugin to ship snapshot off to tank
    ...
    def set_admin_password(self, instance, new_pass):
        ...
        This is done via an agent running on the VM. Communication between engine
    ...
    def _destroy_kernel_ramdisk_plugin_call(self, kernel, ramdisk):
        ...
        task = self._session.async_call_plugin(
            'tank', 'remove_kernel_ramdisk', args)
    ...
    def poll_rebooting_instances(self, timeout):
        ...
        ctxt = engine_context.get_admin_context()
