...
from engine.virt.libvirt import utils as libvirt_utils
...
LOG = logging.getLogger('engine.virt.libvirt_conn')
...
flags.DEFINE_string('firewall_driver',
                    'engine.virt.libvirt.firewall.IptablesFirewallDriver',
...
flags.DEFINE_string('libvirt_vif_driver',
                    'engine.virt.libvirt.vif.LibvirtBridgeDriver',
                    'The libvirt VIF driver to configure the VIFs.')
flags.DEFINE_list('libvirt_volume_drivers',
                  ['iscsi=engine.virt.libvirt.volume.LibvirtISCSIVolumeDriver',
                   'local=engine.virt.libvirt.volume.LibvirtVolumeDriver',
                   'fake=engine.virt.libvirt.volume.LibvirtFakeVolumeDriver',
                   'rbd=engine.virt.libvirt.volume.LibvirtNetVolumeDriver',
                   'sheepdog=engine.virt.libvirt.volume.LibvirtNetVolumeDriver'],
...
class LibvirtConnection(driver.ComputeDriver):
    ...
    def snapshot(self, context, instance, image_href):
        ...
        (image_service, image_id) = engine.image.get_image_service(
            context, instance['image_ref'])
        base = image_service.show(context, image_id)
        (snapshot_image_service, snapshot_image_id) = \
            engine.image.get_image_service(context, image_href)
        ...
        if FLAGS.use_cow_images:
            source_format = 'qcow2'
        # NOTE(vish): tank forces ami disk format to be ami
    ...
    def _create_image(self, context, inst, libvirt_xml, suffix='',
        ...
        admin_context = engine_context.get_admin_context()
    ...
    def _prepare_xml_info(self, instance, network_info, image_meta, rescue,
        ...
        if root_device_name:
            ...
            # NOTE(yamahata):
            # for engine.api.ec2.cloud.CloudController.get_metadata()
            xml_info['root_device'] = self.default_root_device
            db.instance_update(
                engine_context.get_admin_context(), instance['id'],
    ...
    def _lookup_by_name(self, instance_name):
        ...
        relevant engine exceptions should be raised in response.
    ...
    def get_local_gb_total():
        ...
        :returns:
            ...
            ENGINE-INST-DIR/instances mounts.
    ...
    def update_available_resource(self, ctxt, host):
        ...
        This method is called when engine-coompute launches, and
    ...
    def ensure_filtering_rules_for_instance(self, instance_ref, network_info,
        ...
        - setup_basic_filtering (for engine-basic, etc.)
        - prepare_instance_filter(for engine-instance-instance-xxx, etc.)
        ...
        :params instance_ref: engine.db.sqlalchemy.models.Instance object
        ...
        # setting up engine-instance-instance-xx mainly.
    ...
    def live_migration(self, ctxt, instance_ref, dest,
        ...
        :params instance_ref:
            engine.db.sqlalchemy.models.Instance object
            instance object that is migrated.
        :params dest: destination host
        :params block_migration: destination host
        :params post_method:
            post operation method.
            expected engine.compute.manager.post_live_migration.
        :params recover_method:
            recovery method when any exception occurs.
            expected engine.compute.manager.recover_live_migration.
    ...
    def pre_block_migration(self, ctxt, instance_ref, disk_info_json):
        ...
        if instance_ref['kernel_id']:
            ...
            libvirt_utils.fetch_image(engine_context.get_admin_context(),
