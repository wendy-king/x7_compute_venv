...
FILTERS_MODULES = ['engine.rootwrap.compute',
                   'engine.rootwrap.network',
                   'engine.rootwrap.volume',
                  ]


def load_filters():
    """Load filters from modules present in engine.rootwrap."""
    filters = []
    for modulename in FILTERS_MODULES:
        try:
            ...
            # shipped with specific nodes rather than with python-engine
            pass
    return filters
