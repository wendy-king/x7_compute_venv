...
The Compute API specification is published to http://docs.x7.org/api and the source is found in https://github.com/x7/compute-api. These extensions extend the core API. 
