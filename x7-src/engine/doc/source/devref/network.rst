...
The :mod:`engine.network.manager` Module
--------------------------------------

.. automodule:: engine.network.manager
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:

The :mod:`engine.network.linux_net` Driver
----------------------------------------

.. automodule:: engine.network.linux_net
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
...
.. automodule:: engine.tests.network_unittest
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
...
The engine networking components manage private networks, public IP addressing, VPN connectivity, and firewall rules.
...
* BridgingNode (a subclass of the basic engine ComputeNode)
