...
The responsibilities of Services, Managers, and Drivers, can be a bit confusing to people that are new to engine.  This document attempts to outline the division of responsibilities to make understanding the system a little bit easier.
...
The :mod:`engine.service` Module
------------------------------

.. automodule:: engine.service
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
...
The :mod:`engine.manager` Module
------------------------------

.. automodule:: engine.manager
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
