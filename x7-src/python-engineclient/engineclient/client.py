...
# All Rights Reserved.
"""
X7 Client interface. Handles the REST calls and responses.
"""
...
from engineclient import service_catalog
...
class HTTPClient(httplib2.Http):
    ...
    USER_AGENT = 'python-engineclient'
    ...
    def http_log(self, args, kwargs, resp, body):
        if 'ENGINECLIENT_DEBUG' in os.environ and os.environ['ENGINECLIENT_DEBUG']:
    ...
    def authenticate(self):
        ...
        if self.version == "v2.0":  # FIXME(chris): This should be better.
            while auth_url:
                if "ENGINE_RAX_AUTH" in os.environ:
            ...
            # In some configurations engine makes redirection to
...
def get_client_class(version):
    try:
        version = str(version)
        client_path = {
            '1.1': 'engineclient.v1_1.client.Client',
            '2': 'engineclient.v1_1.client.Client',
        }[version]
