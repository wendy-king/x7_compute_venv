...
def do_discover(cs, args):
    ...
    Keystone found at https://x7.org/
        - supports version v1.0 (DEPRECATED) here https://x7.org/v1.0
        - supports version v1.1 (CURRENT) here https://x7.org/v1.1
        - supports version v2.0 (BETA) here https://x7.org/v2.0
    """
