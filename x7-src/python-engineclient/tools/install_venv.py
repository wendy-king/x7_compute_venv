...
"""
Installation script for Engine's development virtualenv
"""
...
def install_dependencies(venv=VENV):
    ...
    # Tell the virtual env how to "import engine"
...
def print_help():
    help = """
    python-engineclient development environment setup is complete.

    python-engineclient development uses virtualenv to track and manage Python
    dependencies while in development and testing.

    To activate the python-engineclient virtualenv for the extent of your current
