...
class ShellTest(utils.TestCase):
    ...
    def setUp(self):
        ...
        self.shell = engineclient.shell.X7ComputeShell()

        #HACK(bcwaldon): replace this when we start using stubs
        self.old_get_client_class = engineclient.client.get_client_class
        engineclient.client.get_client_class = lambda *_: fakes.FakeClient
    ...
    def tearDown(self):
        ...
        #HACK(bcwaldon): replace this when we start using stubs
        engineclient.client.get_client_class = self.old_get_client_class
